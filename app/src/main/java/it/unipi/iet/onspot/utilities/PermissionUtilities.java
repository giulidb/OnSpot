...
public abstract class PermissionUtilities {
    ...
    public static void requestPermission(AppCompatActivity activity, int requestId,
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(activity, permission)) {
            ...
            PermissionUtilities.RationaleDialog.newInstance(requestId, finishActivity)
     ...
     * permission.
     * The activity should implement android.support.v4.app.ActivityCompat.OnRequestPermissionsResultCallback
